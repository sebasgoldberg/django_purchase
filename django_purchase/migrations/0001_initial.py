# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-27 04:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Cantidad')),
                ('item', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='resolution', to='django_purchase.PurchaseListItem')),
            ],
        ),
        migrations.CreateModel(
            name='ShippingMethod',
